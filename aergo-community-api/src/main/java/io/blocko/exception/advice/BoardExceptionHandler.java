...
public class BoardExceptionHandler {
	...
	private String handleBoardNotFoundException(BoardNotFoundException ex) {
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	@ResponseBody
	private ResultForm handleRestBoardNotFoundException(RestBoardNotFoundException ex) {
